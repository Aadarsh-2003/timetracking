		...
		<section class="login-content">
			<div class="row m-0 align-items-center bg-white vh-100">
				<div
					...
					<img src="../../assets/images/auth/05.png"
								...
								<div class="card-body">
									...
									<form action="/recoverpassword" method="post">
										...
										<div class="d-flex justify-content-center">
											<button type="submit" class="btn btn-primary">Recover
												</button>
											&nbsp;&nbsp;
											<a href="/login"
												class="btn btn-primary bg-danger">Login</a>
										</div>
