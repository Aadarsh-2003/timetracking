					...
					<div class="card">
						<div class="card-header d-flex justify-content-between">
							<div class="header-title">
								<h4 class="card-title">New Project Status</h4>
							</div>
						</div>
						<div class="card-body">
							...
							<form action="/savemodule" method="post" class="form-horizontal">
								...
								<div class="form-group row">
									<label class="control-label col-sm-3 align-self-center mb-0"
										for="pwd2">DocURL:</label>
									<div class="col-sm-9">
										<input type="text" class="form-control" id="pwd2"
											placeholder="Enter Your DocURL" name="docURL">
									</div>
								</div>
								<div class="form-group row">
									<label class="control-label col-sm-3 align-self-center mb-0"
										for="pwd2">EstimatedHours:</label>
									<div class="col-sm-9">
										<input type="number" class="form-control" id="pwd2"
											placeholder="Enter EstimatedHours" name="estimatedHours">
									</div>
								</div>
								<div class="form-group row">
									<label class="control-label col-sm-3 align-self-center mb-0"
										for="pwd2">TotalUtilizedHours :</label>
									<div class="col-sm-9">
										<input type="number" class="form-control" id="pwd2"
											placeholder="Enter TotalUtilizedHours" name="totalUtilizedHours">
									</div>
								</div>
								<div class="form-group row">
									<label class="control-label col-sm-3 align-self-center mb-0"
										for="pwd2">Description :</label>
									<div class="col-sm-9">
										
											<textarea rows="5" cols="15" class="form-control"class="form-control" name="description"></textarea>
									</div>
								</div>
