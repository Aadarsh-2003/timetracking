                        ...
                        <div class="card-body">
                           ...
                           <form action="/saveuser" method="post" >
                              <div class="row">
                                 <div class="col-lg-6">
                                    <div class="form-group">
                                       ...
                                       <input type="text" class="form-control" id="first-name"  name="firstName" placeholder=" ">
                                    </div>
                                 </div>
                                 <div class="col-lg-6">
                                    <div class="form-group">
                                       <label for="last-name" class="form-label">Last Name</label>
                                       <input type="text" class="form-control" id="last-name" name="lastName"  placeholder=" ">
                                    </div>
                                 </div>
                                 ...
                                 <div class="col-lg-6">
                                    <div class="form-group">
                                       ...
                                       <input type="text" class="form-control" id="phone" name="contactNumber" placeholder=" ">
                                    </div>
                                 </div>
                                 <div class="col-lg-6">
                                    <div class="form-group">
                                 ...
                                 <span style="color:red;" >${conPassErr}</span>
                                 <div class="col-lg-6">
                                    <div class="form-group">
                                 ...
                                 <div class="col-lg-6">
                                    <div class="form-group">
                                       ...
                                       <textarea rows="3" cols="17" name="address" ></textarea>
                                    </div>
                                 </div>
                                 <div class="col-lg-6">
                                    <div class="form-group">
                              ...
                              <p class="mt-3 text-center">
                                 Already have an Account <a href="/saveuser" class="text-underline">Sign In</a>
                              </p>
                           </form>
                        </div>
                     </div>    
