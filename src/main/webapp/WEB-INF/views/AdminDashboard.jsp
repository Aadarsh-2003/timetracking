...
<body class="  " data-aos-easing="ease" data-aos-duration="700"
	data-aos-delay="0">
	<!-- loader Start -->
			...
			<div class="row">
				<div class="col-md-12 col-lg-12">
					<div class="row row-cols-1">
						<div
							class="overflow-hidden d-slider1 swiper-container-initialized swiper-container-horizontal swiper-container-pointer-events">
							<ul class="p-0 m-0 mb-2 swiper-wrapper list-inline"
								id="swiper-wrapper-27cb9407bd5110d11" aria-live="polite"
								style="transition-duration: 0ms; transform: translate3d(0px, 0px, 0px);">
								<li
									class="swiper-slide card card-slide aos-init aos-animate swiper-slide-active"
									data-aos="fade-up" data-aos-delay="700" role="group"
									aria-label="1 / 7" style="width: 276.25px; margin-right: 32px;">
									<div class="card-body">
										<div class="progress-widget">
											<div id="circle-progress-01"
												class="text-center circle-progress-01 circle-progress circle-progress-primary"
												data-min-value="0" data-max-value="100" data-value="90"
												data-type="percent" role="progressbar" aria-valuemin="0"
                              ...
                              <path fill="currentColor"
								...
								<li
									class="swiper-slide card card-slide aos-init aos-animate swiper-slide-next"
									data-aos="fade-up" data-aos-delay="800" role="group"
									aria-label="2 / 7" style="width: 276.25px; margin-right: 32px;">
									<div class="card-body">
										<div class="progress-widget">
                              ...
                              <path fill="currentColor"
								...
								<li class="swiper-slide card card-slide aos-init aos-animate"
									data-aos="fade-up" data-aos-delay="900" role="group"
									aria-label="3 / 7" style="width: 276.25px; margin-right: 32px;">
									<div class="card-body">
										<div class="progress-widget">
                              ...
                              <path fill="currentColor"
												...
												<svg version="1.1" width="100" height="100"
													...
													<circle class="circle-progress-circle" cx="50" cy="50"
														r="46" fill="none" stroke="#ddd" stroke-width="8"></circle>
													<path
														d="M 50 4 A 46 46 0 1 1 6.25140025042294 64.2147817412476"
														class="circle-progress-value" fill="none" stroke="#00E699"
														stroke-width="8"></path>
													<text class="circle-progress-text" x="50" y="50"
														font="16px Arial, sans-serif" text-anchor="middle"
														fill="#999" dy="0.4em">70%</text></svg>
											</div>
											<div class="progress-detail">
								...
								<li class="swiper-slide card card-slide aos-init aos-animate"
									data-aos="fade-up" data-aos-delay="1000" role="group"
									aria-label="4 / 7" style="width: 276.25px; margin-right: 32px;">
									<div class="card-body">
										<div class="progress-widget">
											<div id="circle-progress-04"
												...
												data-type="percent" role="progressbar" aria-valuemin="0"
												aria-valuemax="100" aria-valuenow="60">
                              ...
                              <path fill="currentColor"
												...
												<svg version="1.1" width="100" height="100"
													...
													<circle class="circle-progress-circle" cx="50" cy="50"
														r="46" fill="none" stroke="#ddd" stroke-width="8"></circle>
													<path
														d="M 50 4 A 46 46 0 1 1 22.96187839454624 87.21478174124758"
														class="circle-progress-value" fill="none" stroke="#00E699"
														stroke-width="8"></path>
													<text class="circle-progress-text" x="50" y="50"
														font="16px Arial, sans-serif" text-anchor="middle"
														fill="#999" dy="0.4em">60%</text></svg>
											</div>
											<div class="progress-detail">
								...
								<li class="swiper-slide card card-slide aos-init aos-animate"
									data-aos="fade-up" data-aos-delay="1100" role="group"
									aria-label="5 / 7" style="width: 276.25px; margin-right: 32px;">
									<div class="card-body">
										<div class="progress-widget">
                              ...
                              <path fill="currentColor"
												...
												<svg version="1.1" width="100" height="100"
													...
													<circle class="circle-progress-circle" cx="50" cy="50"
														r="46" fill="none" stroke="#ddd" stroke-width="8"></circle>
													<path d="M 50 4 A 46 46 0 0 1 50 96"
														class="circle-progress-value" fill="none" stroke="#00E699"
														stroke-width="8"></path>
													<text class="circle-progress-text" x="50" y="50"
														font="16px Arial, sans-serif" text-anchor="middle"
														fill="#999" dy="0.4em">50%</text></svg>
											</div>
											<div class="progress-detail">
								...
								<li class="swiper-slide card card-slide aos-init aos-animate"
									data-aos="fade-up" data-aos-delay="1200" role="group"
									aria-label="6 / 7" style="width: 276.25px; margin-right: 32px;">
									<div class="card-body">
										<div class="progress-widget">
											<div id="circle-progress-06"
												...
												data-type="percent" role="progressbar" aria-valuemin="0"
												aria-valuemax="100" aria-valuenow="40">
												<svg class="card-slie-arrow icon-24" width="24"
													viewBox="0 0 24 24">
                              <path fill="currentColor"
														d="M19,6.41L17.59,5L7,15.59V9H5V19H15V17H8.41L19,6.41Z"></path>
												...
												<svg version="1.1" width="100" height="100"
													...
													<circle class="circle-progress-circle" cx="50" cy="50"
														r="46" fill="none" stroke="#ddd" stroke-width="8"></circle>
													<path
														d="M 50 4 A 46 46 0 0 1 77.03812160545377 87.21478174124758"
														class="circle-progress-value" fill="none" stroke="#00E699"
														stroke-width="8"></path>
													<text class="circle-progress-text" x="50" y="50"
														font="16px Arial, sans-serif" text-anchor="middle"
														fill="#999" dy="0.4em">40%</text></svg>
											</div>
											<div class="progress-detail">
								...
								<li class="swiper-slide card card-slide aos-init aos-animate"
									data-aos="fade-up" data-aos-delay="1300" role="group"
									aria-label="7 / 7" style="width: 276.25px; margin-right: 32px;">
									<div class="card-body">
										<div class="progress-widget">
                              ...
                              <path fill="currentColor"
												...
												<svg version="1.1" width="100" height="100"
													...
													<circle class="circle-progress-circle" cx="50" cy="50"
														r="46" fill="none" stroke="#ddd" stroke-width="8"></circle>
													<path
														d="M 50 4 A 46 46 0 0 1 93.74859974957707 64.21478174124758"
														class="circle-progress-value" fill="none" stroke="#00E699"
														stroke-width="8"></path>
													<text class="circle-progress-text" x="50" y="50"
														font="16px Arial, sans-serif" text-anchor="middle"
														fill="#999" dy="0.4em">30%</text></svg>
											</div>
											<div class="progress-detail">
							...
							<div class="swiper-button swiper-button-next" tabindex="0"
								...
								aria-controls="swiper-wrapper-27cb9407bd5110d11"
			...
			<div class="row">
				<div class="col-lg-12">
					...
					<div class="d-grid gap-3 grid-cols-3 mb-4">
                      ...
                      <path fill="currentColor"
									d="M7,2V13H10V22L17,10H13L17,2H7Z"></path>
                  </svg>
						...
						<div class="btn btn-border" data-setting="color-mode"
							...
							<svg class="icon-20" width="20" viewBox="0 0 24 24" fill="none"
								xmlns="http://www.w3.org/2000/svg">
                      <path fill="currentColor"
									d="M9,2C7.95,2 6.95,2.16 6,2.46C10.06,3.73 13,7.5 13,12C13,16.5 10.06,20.27 6,21.54C6.95,21.84 7.95,22 9,22A10,10 0 0,0 19,12A10,10 0 0,0 9,2Z"></path>
                  </svg>
					...
					<div class="grid-cols-5 mb-4 d-grid gap-x-2">
						<div class="btn btn-border bg-transparent"
							...
							<svg class="customizer-btn icon-32"
								...
								width="32"> <circle cx="12" cy="12" r="10" fill="#00C3F9"></circle> <path
									d="M2,12 a1,1 1 1,0 20,0" fill="#573BFF"></path></svg>
						</div>
						<div class="btn btn-border bg-transparent"
							...
							<svg class="customizer-btn icon-32"
								xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
								width="32"> <circle cx="12" cy="12" r="10" fill="#91969E"></circle> <path
									d="M2,12 a1,1 1 1,0 20,0" fill="#FD8D00"></path></svg>
						</div>
						<div class="btn btn-border bg-transparent"
							...
							<svg class="customizer-btn icon-32"
								xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
								width="32"> <circle cx="12" cy="12" r="10" fill="#DB5363"></circle> <path
									d="M2,12 a1,1 1 1,0 20,0" fill="#366AF0"></path></svg>
						</div>
						<div class="btn btn-border bg-transparent"
							...
							<svg class="customizer-btn icon-32"
								xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
								width="32"> <circle cx="12" cy="12" r="10" fill="#EA6A12"></circle> <path
									d="M2,12 a1,1 1 1,0 20,0" fill="#6410F1"></path></svg>
						</div>
						<div class="btn btn-border bg-transparent"
							...
							<svg class="customizer-btn icon-32"
								xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
								width="32"> <circle cx="12" cy="12" r="10" fill="#E586B3"></circle> <path
									d="M2,12 a1,1 1 1,0 20,0" fill="#25C799"></path></svg>
						</div>
