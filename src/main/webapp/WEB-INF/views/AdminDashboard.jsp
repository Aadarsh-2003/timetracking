							...
							<ul class="p-0 m-0 mb-2 swiper-wrapper list-inline"
                              ...
                              <path fill="currentColor"
											...
											<div class="progress-detail">
												...
												<h4 class="counter" style="visibility: visible;">${TotalProj}</h4>
											</div>
										</div>
									</div>
								</li>
                              ...
                              <path fill="currentColor"
											...
											<div class="progress-detail">
												...
												<h4 class="counter" style="visibility: visible;">${OngoingProj}</h4>
											</div>
										</div>
									</div>
								</li>
                              ...
                              <path fill="currentColor"
											...
											<div class="progress-detail">
												...
												<h4 class="counter" style="visibility: visible;">${PipelineProj}</h4>
											</div>
										</div>
									</div>
								</li>
                              ...
                              <path fill="currentColor"
											...
											<div class="progress-detail">
												<p class="mb-2">Due Projects</p>
												<h4 class="counter" style="visibility: visible;">${DueProj}</h4>
											</div>
										</div>
									</div>
								</li>
